...
" General
Plugin 'neoclide/coc.nvim', {'branch': 'release'}  " auto-complete
...
nnoremap q <c-v>  " q to enter visual block mode
nnoremap qq q  " qq to record macro

" To auto complete parentheses, brackets, quotes, etc
inoremap ( ()<Esc>i
inoremap { {}<Esc>i
inoremap {<CR> {<CR>}<Esc>O
inoremap [ []<Esc>i
"inoremap < <><Esc>i  messes up html tag auto closing
inoremap ' ''<Esc>i
inoremap " ""<Esc>i
...
" indentation rules
au BufNewFile,BufRead *.py,*.sql,*json
    \  set tabstop=4
    \| set softtabstop=4
    \| set shiftwidth=4
   "\| set textwidth=79 - auto indents after 80 characters
    \| set expandtab
    \| set autoindent
    \| set fileformat=unix
...
au BufNewFile,BufRead *.js,*.html,*.css,*.sh,*.ts,*.yaml
    \  set tabstop=2
    \| set softtabstop=2
    \| set shiftwidth=2
    \| set expandtab
...
" Display documentation on cursor hover
